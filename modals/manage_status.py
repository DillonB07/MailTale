    ...
    return {
        ...
        "blocks": [
            ...
            },
            {
                ...
                "text": {
                    "type": "mrkdwn",
                    "text": "Currently you are receiving mail each month! :roo-yay:" if not paused else "You are not currently receiving mail each month. :roo-sad:"
                }
            },
            {
                "type": "actions",
                "elements": [
                    {
                        ...
                        "text": {
                            "type": "plain_text",
                            "text": "Pause Subscription" if not paused else "Resume Subscription",
                            "emoji": True
                        },
                        "confirm": {
                            "text": {   
